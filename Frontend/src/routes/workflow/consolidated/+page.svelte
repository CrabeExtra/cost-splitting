<script>
    ...
    let title = 'Create Consolidated Expense';

    let subtitle =
        'Create an expense where each person pays less than buying separately, but people may want different amounts.';
...
>
    <div class="people-section">
        ...
        {#each selectedPeople as person, index}
            ...
            <input
                list={person.localId + '-weight'}
                placeholder="Search or enter weighting"
                type="number"
                value={person.weight}
                oninput={(e) => {
